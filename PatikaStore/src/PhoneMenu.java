...
public class PhoneMenu extends Menu {
    ...
    public static void deletePhone(ArrayList<MobilePhone> phone) {
        ...
        if (indexToRemove != -1) {
            ...
            System.out.println("ÜRÜN SİLİNDİ.");
            showPhones();
        } else {
    ...
    static {
        phones.add(new MobilePhone(101, 1000, 0.20, 100, "Galaxy S12+", "Samsung", 64, 6.1, 8, "Beyaz", 4000));
        phones.add(new MobilePhone(102, 2000, 0.10, 50, "Iphone 15 Pro MAX", "Apple", 128, 6.4, 16, "Gri", 5000));
